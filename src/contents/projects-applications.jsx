    ...
    <div className="bg-line">
      ...
      <div className="container">
        ...
        <div className="row mt-5">
          <div className="col-12 col-sm-12 col-md-4" data-aos="fade-right">
            <p className="dark-black mb-0">Project & Application</p>
            <h2 className="dark-black">UI/UX</h2>
          </div>
        </div>
        ...
        <div className="row py-5">
          ...
          <div className="col-12 col-sm-12 col-md-3" data-aos="fade-up">
            <div className="d-flex gap-2">
              <div>
                <p className="dark-black text-xl fw-500">01</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-500">DIETIO UI/UX</p>
              </div>
            </div>
          ...
          <div className="col-12 col-sm-12 col-md-3 " data-aos="fade-up">
            <div className="d-flex gap-2">
              <div>
                <p className="dark-black text-xl fw-500">02</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-500">M-Banking (Clone)</p>
              </div>
            </div>
            <div className="d-flex flex-column align-items-center">
          ...
          <div className="col-12 col-sm-12 col-md-3 " data-aos="fade-up">
            <div className="d-flex gap-2">
              <div>
                <p className="dark-black text-xl fw-500">03</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-500">Rentable</p>
              </div>
            </div>
            <div className="d-flex flex-column align-items-center">
          ...
          <div className="col-12 col-sm-12 col-md-3 " data-aos="fade-up">
            <div className="d-flex gap-2">
              <div>
                <p className="dark-black text-xl fw-500">04</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-500">Chromatic Cinema</p>
              </div>
            </div>
            <div className="d-flex flex-column align-items-center">
              ...
              <div className="row">
                ...
                <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column">
                  <div className="d-flex align-items-center gap-2">
                    <p className="dark-black text-xl fw-700 mb-0">01</p>
                    <h2 className="dark-black text-xl fw-900 mb-0">DIETIO</h2>
                  </div>
                  <div>
                    <p className="dark-black">About Project</p>
            ...
            <div id="content2">
              <div className="row">
                <div className="col-12 col-sm-12 col-md-3">
                  <h2 className="dark-black fw-900 mb-0">Diet Io MockUps</h2>
                </div>
        ...
        <div className={`container py-5 ${activeContent2 === 3 ? "" : "d-none"}`} id="content3" data-aos="fade-up">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column">
              <div className="d-flex align-items-center gap-2">
                <p className="dark-black text-xl fw-900 mb-0">02</p>
                <h2 className="dark-black text-xl fw-900 mb-0">M-Banking (Clone)</h2>
              </div>
              <div>
                <p className="dark-black">About Project</p>
                <p className="dark-black">
        ...
        <div className={`container py-5 ${activeContent2 === 4 ? "" : "d-none"}`} id="content4">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-3 text-center">
              <h2 className="dark-black fw-900 mb-0">M-Banking (Clone) MockUps</h2>
            </div>
            <div className="col-12 col-sm-12 col-md-3 text-center">
        ...
        <div className={`container py-5 ${activeContent3 === 5 ? "" : "d-none"}`} id="content5" data-aos="fade-up">
          <div className="row">
            ...
            <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column">
              <div className="d-flex align-items-center gap-2">
                <p className="dark-black text-xl fw-700 mb-0">03</p>
                <h2 className="dark-black text-xl fw-900 mb-0">Rentable</h2>
              </div>
              <div>
                <p className="dark-black">About Project</p>
                <p className="dark-black">
        ...
        <div className={`container py-5 ${activeContent3 === 6 ? "" : "d-none"}`} id="content6">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-3 text-center">
              <h2 className="dark-black fw-900 mb-0">Rentable MockUps</h2>
            </div>
            <div className="col-12 col-sm-12 col-md-3 text-center">
        ...
        <div className={`container py-5 ${activeContent4 === 7 ? "" : "d-none"}`} id="content7" data-aos="fade-up">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column">
              <div className="d-flex align-items-center gap-2">
                <p className="dark-black text-xl fw-700 mb-0">04</p>
                <h2 className="dark-black text-xl fw-900 mb-0">Chromatic Cinema</h2>
              </div>
              <div>
                <p className="dark-black">About Project</p>
                <p className="dark-black">
        ...
        <div className={`container py-5 ${activeContent4 === 8 ? "" : "d-none"}`} id="content8">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-3 text-center">
              <h2 className="dark-black fw-900 mb-0">Chromatic Cinema MockUps</h2>
            </div>
            <div className="col-12 col-sm-12 col-md-3 text-center">
      ...
      <div className="row mt-5" data-aos="fade-up">
        <div className="col-12 col-sm-12 col-md-4">
          <p className="dark-black mb-0">Project & Application</p>
          <h2 className="dark-black">WEB</h2>
        </div>
      </div>
        <div className="row py-5">
          <div className="col-12 col-sm-12 col-md-6" data-aos="fade-up">
            <div className="d-flex gap-2 ">
              <div>
                <p className="dark-black text-xl fw-700">01</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-700">Ticks</p>
              </div>
            </div>
            <div className="d-flex flex-column align-items-center">
          ...
          <div className="col-12 col-sm-12 col-md-6" data-aos="fade-up">
            <div className="d-flex gap-2">
              <div>
                <p className="dark-black text-xl fw-700">02</p>
              </div>
              <div>
                <p className="dark-black text-xl fw-700">Super Cats(On Progress)</p>
              </div>
            </div>
            <div className="d-flex flex-column align-items-center">
          ...
          <div className="row my-5">
            <div className="col-12 col-sm-12 col-md-6" data-aos="fade-up">
              <div className="d-flex gap-2 ">
                <div>
                  <p className="dark-black text-xl fw-700">03</p>
                </div>
                <div>
                  <p className="dark-black text-xl fw-700">Pokemon</p>
                </div>
              </div>
              <div className="d-flex flex-column align-items-center">
            ...
            <div className="col-12 col-sm-12 col-md-6" data-aos="fade-up">
              <div className="d-flex gap-2">
                <div>
                  <p className="dark-black text-xl fw-700">04</p>
                </div>
                <div>
                  <p className="dark-black text-xl fw-700">CareerSearch</p>
                </div>
              </div>
              <div className="d-flex flex-column align-items-center">
          ...
          <div className="container py-5">
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column" data-aos="fade-up">
                <div className="d-flex align-items-center gap-2">
                  <p className="dark-black text-xl fw-700 mb-0">01</p>
                  <h2 className="dark-black text-xl fw-900 mb-0">Ticks</h2>
                </div>
                <div>
                  <p className="dark-black">About Project</p>
                  <p className="dark-black">ticks is the online purchase and sale of concert tickets website to make it easier for users to buy concert tickets, Also checked is the like best category sellers, ticket recommendations & promos. ticks is a project from campus where we, as information systems students studying digital technology, created a website in groups, ticks was my group and I's first experience creating a website, ticks was created using HTML, CSS, and Javascript</p>
          ...
          <div className="container py-5">
            <div className="row justify-content-center">
              <div className="col-12" data-aos="fade-up">
                <h2 className="dark-black">Ticks MockUps</h2>
              </div>
              <div className="row my-5">
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  ...
                  <p className="dark-black fw-700 text-md mt-2"> Homepage</p>
                </div>
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  <img src="/assets/ticks3.jpeg" alt="" className="img-fluid "/>
                  <p className="dark-black fw-700 text-md mt-2"> Homepage (scrolldown)</p>
                </div>
              </div>
              <div className="row my-5">
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  <img src="/assets/ticks4.jpeg" alt="" className="img-fluid "/>
                  <p className="dark-black fw-700 text-md mt-2"> Ticket Page</p>
                </div>
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  <img src="/assets/ticks5.jpeg" alt="" className="img-fluid "/>
                  <p className="dark-black fw-700 text-md mt-2"> Ticket Detail Page</p>
                </div>
              </div>
              <div className="row my-5">
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  <img src="/assets/ticks6.jpeg" alt="" className="img-fluid "/>
                  <p className="dark-black fw-700 text-md mt-2"> Register Detail Page</p>
                </div>
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
                  <img src="/assets/ticks7.jpeg" alt="" className="img-fluid "/>
                  <p className="dark-black fw-700 text-md mt-2"> PromotionPage</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container py-5">
            <div className="row justify-content-center">
              <div className="col-12" data-aos="fade-up">
                <h2 className="dark-black">Super Cats MockUps</h2>
              </div>
              <div className="row my-5">
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
          ...
          <div className="container py-5">
            <div className="row justify-content-center">
              <div className="col-12" data-aos="fade-up">
                <h2 className="dark-black">Pokemon MockUps</h2>
              </div>
              <div className="row my-5">
                <div className="col-12 col-sm-12 col-md-6 d-flex flex-column" data-aos="fade-up">
          ...
          <div className="container py-5">
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-start flex-column" data-aos="fade-up">
                <div className="d-flex align-items-center gap-2">
                  <p className="dark-black text-xl fw-700 mb-0">04</p>
                  <h2 className="dark-black text-xl fw-900 mb-0">CareerSearch</h2>
                </div>
                <div>
                  <p className="dark-black">About Project</p>
                  <p className="dark-black">CareerSearch is a group project work where I as the front end is tasked with creating an attractive and responsive appearance, this website is useful for job seekers. Here, we can search for many job opportunities and apply directly. After that, we can check the status of our job application to find out whether it has been accepted or not. but unfortunately because this website can't run anymore because we use the railway and you have to pay monthly but here is the documentation from careersearch itself <a className="fw-700" href="https://github.com/widiapuspitasar/CareerSearch_ProjectRevou">linkcareersearch</a> . For this project on the front end I used Vite React, Tailwind CSS and Material UI</p>
                  <div className="col-12 d-flex gap-3">
